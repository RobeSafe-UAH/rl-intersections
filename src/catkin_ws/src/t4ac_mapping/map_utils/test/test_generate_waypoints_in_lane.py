"""
Script for testing the method generate_waypoints_in_lane.
...
from map_utils import generate_waypoints_in_lane
from map_utils import get_road
from map_utils import get_lane
...
road = get_road(t4ac_map_object.roads, 13)
lane = get_lane(road, 1, 0)
t4ac_waypoints = generate_waypoints_in_lane(road, lane, 1)
