...
class CarlaEgoVehicleInfo(genpy.Message):
  _md5sum = "7635942a53dfdf0edbbafc9eea467602"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.wheels:
        _x = val1
        buff.write(_get_struct_6f().pack(_x.tire_friction, _x.damping_rate, _x.max_steer_angle, _x.radius, _x.max_brake_torque, _x.max_handbrake_torque))
        _v1 = val1.position
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.tire_friction, _x.damping_rate, _x.max_steer_angle, _x.radius, _x.max_brake_torque, _x.max_handbrake_torque,) = _get_struct_6f().unpack(str[start:end])
        _v2 = val1.position
        _x = _v2
        start = end
        end += 24
