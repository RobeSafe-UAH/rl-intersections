...
"""autogenerated by genpy from t4ac_msgs/DM_posestamped.msg. Do not edit."""
import codecs
import sys
...
class DM_posestamped(genpy.Message):
  _md5sum = "74ec6b5a856c06afff73c472464844fa"
  _type = "t4ac_msgs/DM_posestamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','t4ac_msgs/DM_pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DM_posestamped, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.pose is None:
        self.pose = t4ac_msgs.msg.DM_pose()
    else:
      self.header = std_msgs.msg.Header()
      self.pose = t4ac_msgs.msg.DM_pose()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.pose.lane_change = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.pose.lane_change = str[start:end]
      return self
