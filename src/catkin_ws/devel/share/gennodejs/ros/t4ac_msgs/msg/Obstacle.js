...
class Obstacle {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('dist2ego')) {
        this.dist2ego = initObj.dist2ego
      }
      else {
        this.dist2ego = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [dist2ego]
    bufferOffset = _serializer.float64(obj.dist2ego, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [dist2ego]
    data.dist2ego = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.dist2ego !== undefined) {
      resolved.dist2ego = msg.dist2ego;
    }
    else {
      resolved.dist2ego = 0.0
    }
